...
|:-------------|:--:|:---:|:--:|:--:|
|duration (ms) | 20 | 47  | 41 | 32 |

### $\color{#fffff}{\text{📊 2. ECG and Pulse}}$ <br>
|R to start of pulse upswing (ms) |T to dip after peak of pulse (ms) |
|:--------------------------------|:---------------------------------|
|237                              |291                               |

### $\color{#fffff}{\text{📊 2. ECG and Pulse: With Exercise}}$ <br>
|Interval      | PR | QRS | ST | TP |
|:-------------|:--:|:---:|:--:|:--:|
